<x-dashboard.sidebar.header>{{ __('settings.title') }}</x-dashboard.sidebar.header>

<x-dashboard.sidebar.dropdown :active="request()->routeIs('dashboard.settings*')">
    <x-slot:svg>
    ...
    <x-dashboard.sidebar.item :active="request()->routeIs('dashboard.settings.index') && request()->route('tab') === 'main'" :link="route('dashboard.settings.index', 'main')">
        {{ __('settings.tabs.main') }}
    </x-dashboard.sidebar.item>

    <x-dashboard.sidebar.item :active="request()->routeIs('dashboard.settings.index') && request()->route('tab') === 'mail'" :link="route('dashboard.settings.index', 'mail')">
        {{ __('settings.tabs.mail') }}
    </x-dashboard.sidebar.item>

    <x-dashboard.sidebar.item :active="request()->routeIs('dashboard.settings.index') && request()->route('tab') === 'sms'" :link="route('dashboard.settings.index', 'sms')">
        {{ __('settings.tabs.sms') }}
    </x-dashboard.sidebar.item>
