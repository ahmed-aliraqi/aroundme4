...
class OTP
{
     ...
     */
    const string VALID_STATUS = 'VALID';

    /**
     * The code of invalid status.
     */
    const string INVALID_STATUS = 'INVALID';

    /**
     * The code of expired status.
     */
    const string EXPIRED_STATUS = 'EXPIRED';
     ...
     */
    public function generate(mixed $otp = null): self
    {
        // Generate the OTP.
     ...
     */
    public function validate(string $token, string|int $otp): self
    {
    ...
    public function decryptToken(string $token = ''): self
    {
        try {
