import { defineComponent, unref, withCtx, createVNode, useSSRContext, useAttrs, ref, computed, watch, mergeProps, createTextVNode, createSSRApp, h } from "vue";
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderAttr, ssrInterpolate, ssrGetDynamicModelProps, ssrRenderStyle, ssrRenderSlot } from "vue/server-renderer";
import { Head, Link, createInertiaApp } from "@inertiajs/vue3";
import { trans, i18nVue } from "laravel-vue-i18n";
...
const Login = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$1]]);
...
const _sfc_main$2 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div><input${ssrRenderAttrs((_temp0 = mergeProps({ type: "text" }, unref(attrs), {
        name: __props.name,
        value: model.value,
        id: computedId.value,
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/components/Inputs/Text.vue");
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<hr> ${ssrInterpolate(_ctx.$t("users.attributes.name"))} <hr>`);
...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => {
      const pages = /* @__PURE__ */ Object.assign({ "../pages/About.vue": __vite_glob_0_0, "../pages/Auth/Login.vue": __vite_glob_0_1, "../pages/Test.vue": __vite_glob_0_2 });
      const page2 = pages[`../pages/${name}.vue`];
      if (page2 && page2.default && page2.default.layout === void 0) {
        page2.default.layout = AppLayout;
      }
      return page2;
    },
